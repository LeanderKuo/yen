...
| --- | --- | --- | --- | --- |
| [admin-i18n-toggle-spec.md](completed/admin-i18n-toggle-spec.md) | Spec | Stable (Implemented) | 2026-01-19 | Admin i18n Toggle — Spec |
...
| [safety-risk-engine-spec.md](completed/safety-risk-engine-spec.md) | Spec | Stable (Implemented) | 2026-01-19 | AI Safety Risk Engine — Spec |
...
| [GALLERY_HERO_IMAGE_AND_HOTSPOTS.md](proposed/GALLERY_HERO_IMAGE_AND_HOTSPOTS.md) | PRD | Draft | 2026-01-20 | Home（UIUX 跟稿）+ Gallery Hero Image + Image Hotspots（圖上 Pin）- Product Requirements Document (PRD) |
