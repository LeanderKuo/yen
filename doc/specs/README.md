...
| --- | --- | --- | --- | --- |
| [admin-i18n-toggle-spec.md](completed/admin-i18n-toggle-spec.md) | Spec | Stable (Implemented) | 2026-01-04 | Admin i18n Toggle — Spec |
...
| [safety-risk-engine-spec.md](completed/safety-risk-engine-spec.md) | Spec | Stable (Implemented) | 2026-01-17 | AI Safety Risk Engine — Spec |
