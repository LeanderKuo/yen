...
function AdminSidebarContent({
  ...
  const navItems: NavEntry[] = [
    ...
    // Blog (single entry, tabs in layout)
    { divider: true, labelKey: 'blog' },
    {
    ...
    // Gallery (single entry, tabs in layout)
    { divider: true, labelKey: 'gallery' },
    {
    ...
    // Users (single entry, tabs in layout)
    { divider: true, labelKey: 'users' },
    {
    ...
    // Data group (Import/Export, AI Analysis, Embeddings, etc.)
    { divider: true, labelKey: 'data' },
    {
